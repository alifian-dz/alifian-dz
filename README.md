...
![AES Encryption](https://img.shields.io/badge/AES--256-FF0000?style=for-the-badge)
![bcryptjs](https://img.shields.io/badge/bcryptjs-2D3748?style=for-the-badge)
...
<details open>
<summary><b>🔗 BLOCKCHAIN RESEARCHER & DEVELOPER</b> (2021 - Present)</summary>
...
• Cryptographic Security & Encryption Protocols
• IPFS Integration for Decentralized Storage
• Transaction Security & Gas Optimization
```

**RESEARCH FOCUS:**
- Decentralized Data Security Systems using Ethereum Smart Contracts
- AES-256 Encryption integration with blockchain layer
- Secure inter-contract communication patterns
- Gas optimization techniques for large-scale DApps

</details>

<details open>
<summary><b>👔 FULL STACK WEB DEVELOPER INTERN</b> (Sep 2025 - Jan 2026)</summary>

**PT Cloud Digital Innovation**

```
PROJECT SCOPE:
Developed backend synchronization logic and responsive frontend components
using Next.js, Express.js, and Prisma for national-scale SCM and ISP
management platforms.

KEY CONTRIBUTIONS:
• Backend API design with Express.js and PostgreSQL integration via Prisma
• Frontend development using Next.js with responsive Tailwind CSS layouts
...
• Project Lead: Sprint planning, architecture decisions, team coordination
• Frontend Development: Vite + React + Tailwind CSS + Framer Motion
